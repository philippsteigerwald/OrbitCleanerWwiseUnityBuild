...
namespace OscSimpl.Examples 
{
	public class ArgumentTypeTest : MonoBehaviour 
	{
		...
		public void GenerateAndSendBlob()
		{
			...
			for( int p=0; p<pixels.Length; p++ ) pixels[p] = Random.ColorHSV( 0f, 1f, 0.7f, 0.7f, 1f, 1f );
			...
			byte[] blob = _blobOutputTexture.EncodeToPNG(); // This will produce different blob sizes depending on the colors.
