...
namespace OscSimpl
{
	...
	public class OscMappingDrawer : PropertyDrawer
	{
		...
		public override void OnGUI( Rect rect, SerializedProperty mappingProp, GUIContent label )
		{
			...
			if( EditorGUI.EndChangeCheck() ) typeProp.enumValueIndex = newEnumIndex;
		...
		static ReorderableList BuildEntryListUI( SerializedProperty entriesProp )
		{
			...
			list.onAddCallback = ( ReorderableList l ) => {
				...
				SerializedProperty targetAssemblyQualifiedTypeNameProp = newEntryProp.FindPropertyRelative( "targetAssemblyQualifiedTypeName" );
				targetMethodNameProp.stringValue = "";
				targetAssemblyQualifiedTypeNameProp.stringValue = "";
