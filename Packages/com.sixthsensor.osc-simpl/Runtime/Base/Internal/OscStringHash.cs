...
{
	/// <summary>
	/// OscStringHash generates hash keys that can be used to store and look up OSC addresses from strings and from byte streams.
	/// This is all to avoid creating garbage and allowing fast lookups.
	///
